using TesteComercio.Api.Controllers.v1.Users.Requests;
using TesteComercio.ApiFramework.Tools;
using TesteComercio.Application.Users.Command.CreateUser;
using TesteComercio.Application.Users.Command.Login;
using TesteComercio.Application.Users.Command.RefreshToken;
using Mapster;
...
namespace TesteComercio.Api.Controllers.v1.Users
{
    [ApiVersion("1")]
