...
namespace TesteComercio.Api
{
    ...
    using TesteComercio.Api.Configurations;
    ...
    public static class DependencyInjection
    {
        ...
        public static IApplicationBuilder UseAppSwagger(this IApplicationBuilder app, IConfiguration configuration)
        {
            ...
            {
                options.SwaggerEndpoint("/swagger/v1/swagger.json", "TesteComercio.WebUI v1");
                options.SwaggerEndpoint("/swagger/v2/swagger.json", "TesteComercio.WebUI v2");
